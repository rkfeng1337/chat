...
public:
    ...
    bool insertMessage(const MessageInfo &);


    void createTable();


    QList<MessageInfo> getMessageInfo();

    QList<MessageInfo> selectFromSender(const QString &);
    QList<MessageInfo> selectFromDate(const QString &);
    QList<MessageInfo> selectFromKeycode(const QString &);
